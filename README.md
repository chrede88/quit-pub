...
```shell
git clone https://github.com/chrede88/quit-pub
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/quit-pub/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://chrede88.github.io/quit-pub'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/chrede88/quit-pub
  - link: https://github.com/chrede88/quit-pub#readme
...
`https://chrede88.github.io/quit-pub`